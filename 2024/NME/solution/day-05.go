...
func parseDay05(lines []string) ([][]int, map[Rule]struct{}) {
...
func (d Day05) PartOne(lines []string) string {
	orderings, rules := parseDay05(lines)
...
func (d Day05) PartTwo(lines []string) string {
	orderings, rules := parseDay05(lines)
